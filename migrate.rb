...
class MetasploitModule < Msf::Post
  ...
  def initialize(info={})
    ...
    register_options(
      [
        OptBool.new(   'SPAWN',[false,'Spawn process to migrate to. If set, notepad.exe is used.', false]),
        ...
        OptString.new( 'NAME', [false, 'Name of process to migrate to.','explorer.exe']),
